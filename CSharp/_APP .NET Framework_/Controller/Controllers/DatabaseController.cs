...
namespace VIPER.Controller.Controllers
{
    ...
    public class DatabaseController : ApiController
    {
        ...
        public string GravarConnectionString(ConfiguracaoBancoDTO configuracao)
        {
            ...
            if (!web_config.SetValue("CartsysFinanceiroConnectionString", ConnectionString.GetConnectionString(configuracao.Tipo, configuracao.Servidor, configuracao.BancoDadosCartsys, configuracao.Usuario, configuracao.Senha), ref _mensagem))
            {
                return _mensagem;
            }
            else
            {
                ...
                if (!web_config.SetValue("CartsysFinanceiroConnectionString", ConnectionString.GetProviderName(configuracao.Tipo), ref _mensagem))
                {
                    return _mensagem;
                }
                else
