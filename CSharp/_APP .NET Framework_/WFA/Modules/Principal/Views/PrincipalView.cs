...
namespace VIPER.Modules.Principal.Views
{
    public partial class PrincipalView : XtraForm, IPresenterToViewPrincipal
    {
        ...
        private void FrmPrincipalHybrid_Load(object sender, EventArgs e)
        {
            ...
            navButtonTitulo.AppearanceDisabled.BackColor = ConversionDX.SkinNameToColor("Office 2016 Colorful");
            navButtonTitulo.AppearanceHovered.BackColor = ConversionDX.SkinNameToColor("Office 2016 Colorful");
            navButtonTitulo.AppearanceSelected.BackColor = ConversionDX.SkinNameToColor("Office 2016 Colorful");
        }
        ...
        public void SelecionarUsuarioFuncaoSucesso(List<UsuarioFuncaoDTO> dados)
        {
            searchLookUpEditFuncao.Properties.DataSource = dados;
        }

        public void SelecionarUsuarioFuncaoFalha(string mensagem)
        {
