...
namespace VIPER.WFA
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            BonusSkins.Register();
            //UserLookAndFeel.Default.SetSkinStyle(new Sistema.SettingsDefault().SkinName);
            //AppearanceObject.DefaultFont = new Font("Tahoma", (float)new Sistema.SettingsDefault().TamanhoFonte);
